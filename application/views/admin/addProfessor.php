 ...
 <!-- BEGIN PAGE BAR -->
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Add Professor
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green bold uppercase">Professor Information</span>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="col-md-offset-2">
                                             ...
                                             <button class="btn btn-outline btn-lg red"><i class="fa fa-close"></i> Cancel</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
