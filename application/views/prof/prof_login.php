...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>WBES Web Based Examination System | Admin Login</title>
        ...
        <link rel="manifest" href="<?php echo base_url('assets/favicon_io');?>"> </head>
    <!-- END HEAD -->
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="<?php echo base_url(); ?>assets/logo2.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url('prof_login'); ?>" method="post">
                <h3 class="form-title font-green">Instructor | Sign In</h3>
        ...
        <div class="copyright"> 2019 © WB-EXAM. Web-based Examination System. </div>
        <!--[if lt IE 9]>
