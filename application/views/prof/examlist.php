 ...
 <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'prof_subjects/'.$this->session->userdata('uid').'/'.$subject['subj_id']; ?>"><?php echo $subject['subj_code']." ".$subject['subj_name']; ?></a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                 <li>
                                    <u>Examinations</u>
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title">Manage Examinations | <?php echo $subject['subj_code']." ".$subject['subj_name']; ?>
                            <small></small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="<?php echo base_url('prof_banks'); ?>" class="btn btn-lg btn-circle btn-outline green-seagreen"><i class="fa fa-question-circle"></i> Manage Question Banks</a></li>
                                        </ul>
                                        </div>
                                       </div>
                                    </div>
