            ...
            <div class="page-footer-fixed page-footer">
                <div class="page-footer-inner"> 2019 &copy; Web-Based Examination System
        ...
        <script src="<?php echo base_url();?>assets/pages/scripts/form-validation-md.js" type="text/javascript"></script>
